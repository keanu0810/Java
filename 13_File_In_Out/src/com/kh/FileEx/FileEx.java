...
write close exists mkdir
 ...
 메서드
 	...
 	iong	length()		: 파일 크기 알려줌
 	iong	lastModified()	: 파일 마지막 수정일 알려줌
 	long[] list()			: 폴더 내 파일 목록을 String[] 배열로 보여줌
...
/*
 ...
 os : 컴퓨터가 윈도우인지 맥북인지 리눅스인지 나타내는 운영체게
...
public class FileEx {
	public static void main(String[] args) {
		// 		c:C:/Users/user1/Desktop 바탕화면에 폴더만들기

		File 폴더만들기 = new File("c:/Users/user1/Desktop/newFFF");
		
		//바탕화면에 newFFF 라는 폴더가 존재하는 확인
