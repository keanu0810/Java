...
//메서드
	...
	// abstract 나중에 설계도로 완성할 파일에서 필수로 불러워서 완성해야하는 메서드들
	// abstract 메서드는 미완성 메서드이기 떄문에 자식 클래스에서 미완성된 부모클래스를
	// 완성시켜주기 위해서 자식이 부모를 불러올 때 abctract 같은 경우에는
	...
	public void 출력정보() {
		System.out.println("이 도형은 넚이가" + 도형넓이() + "이고 둘레가 " + 도형둘레() + "입니다.");
	}
