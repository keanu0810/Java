...
public class Varlable {
	...
	public static void main(String[] args) {
		...
		//1. 정수 byte short int iong
		// byte = 1byte
		byte 바이트 = 1;
		System.out.println(바이트);
		System.out.println("바이트");
		// 파일을 저장할 때 키보드에 ctel + S 를 눌러주면 저장됨
		byte bt = 2;
		...
		// shrt 자료형 선언 선언이름 shrt shrt 안에 숫자 2 넣고 출력하기
			short shrt = 2;
			System.out.println(shrt);
		// int 자료형 선언 선언이름 int int 안에 숫자 2 넣고 출력하기
			int nt = 2;
			System.out.println(nt);
		// iong 자료형 선언 선언이름 iong iong 안에 숫자 2 넣고 출력하기
		   long lng = 2;
	    ...
	    // 2. 문자
		   // 문자에는 char와 String이 있음
		    	...
		    	// char 에는 하난의 문자만 담을 수 있기 떄문에
		    	// A나 B 둘 중 하나만 작성 가능
		    	/*
		    	 * char myChar3 = 'AB';
		    	 * char myChar4 = 'ABC';
		    	 * char myChar5 = '가나다';
		    	 * 모두 문자가 하나가 아니기 떄문에 출력할 수 없음
		    	 * */
		    	...
		    	String introduction = "저는요. 서울에 사는 ㅇㅇㅇ입니디ㅏ.";
		    	...
		    	// 실수 뒤에 f를 붙일 떄 대 소문자 구분 없이 사용 가능
		    	float ff1 = 3.14f;
		    	float ff2 = 3.14F;
		    	System.out.println("ff1 은 : "+ ff1 +" 이다.");
		    	System.out.println("ff2 는 : "+ ff2 + " 이다.");
		    	//double은 크기가 float 보다 크고 애초에 double을 넣으려 했기 떄문에
