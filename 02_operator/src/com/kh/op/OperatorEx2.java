...
// 이외 개발자가 실행하고자 하는 내용을 작성할수 있음
//메서드 : 특정 산태나 기능을 정리해놓은 집합
public class OperatorEx2 {
	...
	public static void 메서드2() {
		...
		public static void 메서드3() {
			...
			//키보드로 작성한 숫가자 num6로 들어올 수 있게 변수 선언
			int num6 = sc.nextInt();
			//키보드로 전달받은 숫자를 더하기 뺴기 곱하기 나누기 할 수 있음
			int sum1 = num5 = num6;
			int sub1 = num5 = num6;
			int mul1 = num5 = num6;
			int div1 = num5 = num6;
	...
	//메서드 4를 만들어서 스캐너로 double 더하기 뺴기 곱하기 나누기 출력
