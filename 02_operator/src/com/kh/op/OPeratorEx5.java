...
public class OPeratorEx5 {
	...
	public static void main(String[] args) {
		...
		논리 연산자
		&& : 왼쪽 오른쪽 두개의 조건이 모두 참일 떄만 전체 표현이 참
			예를 들어
				(5 == 5) && (5 == 5) true
				(5 != 3) && (3 == 3) true
				(5 == 5) && (5 == 3) false
		...
		왼쪽 >= 오른쪽 : 오른쪽의 값보다 왼쪽이 크거나 같으면 true
						왼쪾이랑 오른쪾이 이상 이하 처럼 같을 떄도 사용하는 표현
		
		왼쪽 < 오른쪽 : 오른쪽의 값이 왼쪽보다 크면 true
					 왼쪾이랑 오른쪽이 초과나 미만일 때 사용하는 표현
		
		왼쪽 <= 오른쪽 : 오른쪽의 값이 왼쪽보다 크거나 같으면 true
					  왼쪽이랑 오른쪽이 이상 이하처럼 같을 떄도 사용하는 표현
		...
		boolean result3 = num1 < num2; // num2 가 num! 보다 크다면 참
