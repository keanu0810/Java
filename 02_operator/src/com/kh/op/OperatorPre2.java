...
public class OperatorPre2 {
	...
	public static void method1() {
		//스캐너로 입력한 값이 true인지 false 인지 해볼것
		...
		System.out.println("a와 b가 다르면 ! = false가 나올것");
		System.out.println("a != b가 : + (a ~= b))");
	}

	
		//method2를 만들어서 증감 연산자를 사용한 다음
		// 비교연산자를 사용해서 값이 같은지 틀린지 확인해볼 것
	public static void method2() {
			Scanner sc = new Scanner(System.in);
			System.out.print("c의 값을 입력하세여 : ");
			int c = sc.nextInt();
			System.out.println("입력한 c의 값");
			// 만약에 11을 입력했다면 c = 11
			System.out.print("d의 값을 입력하세여 : ");
			int d = sc.nextInt();
			
			int e = ++c; // c + = c 넣겠다 해줬기 떄문에 c = 12
			// int f =  ++c; 를 한다면 f의 값은 어떻게 나오는지
			// System.out.println("f : "+ f); f박 출력해보기
			System.out.println("c :" + c + ", d : " + d + ", e : " +e );
			System.out.println("c == d : " + (c ==d));
			System.out.println("c == e : " + (c ==e));
			
			int f = ++c; 
			// c + 1 = c 넣겠다 해줬기 떄문에 c =12 + 1 = 13
	...
	public static void method3() {
		// 최종목표 : 모든 사람이 사탕을골고루 나눠가지려고 한다.
		// 인원수와 사탕 개수를 키보드로 입력받기
		Scanner sc = new Scanner(System.in);
		System.out.println("인원수를 입력하세요 : ");
		int people = sc.nextInt(); //인원수 구하기
		System.out.println("사탕파티에" + people + "명이 참석했습니다.");
		System.out.println("현재 보유하고 있는 총 사탕의 개수를 입력하세요 : ");
		int candies = sc.nextInt();
		System.out.println("현재 가지고 있는 사랑은" + candies + "개 입니다.");
