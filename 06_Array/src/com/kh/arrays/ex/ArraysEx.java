...
sort() : 배열을 정렬
 ...
 List 계열에 추가할 떄
 ArrayList<String> 리스트 = Arrays.as:ist(배열);
 ArrayList<String> 리스트 = Arrays.as:ist{"사과", "바나나"};
 * */
public class ArraysEx {
	...
	System.out.println("숫자 3 으로 모두 채우기 : " + Arrays.toString(똑같은숫자들));
	} 
