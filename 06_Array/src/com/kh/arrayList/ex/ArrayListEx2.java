...
public class ArrayListEx2 {
	...
	public void method2() {
		...
		animal.set(2, "토끼");
		//remove 강아지 삭제
		animal.remove("강아지"); //숫자 말고 이름을 써도 삭제 됨
		//for문을 활용해서 get 출력
	...
	public void method3() {
		...
		pizza.add("포테이토 피자");
		pizza.add("페페로니 피자");
		//pizza 고구마피자 포테이토 피자 페페로니

		//모두 보기
		System.out.println("모든 메뉴 보기 : "+ pizza);
	
		// get 을 활용해서 출력
		System.out.println("메뉴명 : " + pizza.get(0));
		System.out.println("메뉴명 : " + pizza.get(1));
		System.out.println("메뉴명 : " + pizza.get(2));
		
		// set 을 활용해서 페페로니 -> 파인애플
		pizza.set(2, "파인애플 피자");
	
		//remove 파인애플
		pizza.remove("파인애플 피자");
		
		//for 문 활용해서 출력
		for (String 피자 : pizza) {
			System.out.println("메뉴명 : " + 피자);
		}
		System.out.println("피자가게가 사라질 예정입니다.");
		//메뉴 모두 삭제 clear()
		pizza.clear();
		//메뉴 모두 삭제됐는지 확인 isEmpty
		System.out.println("폐업했습니다 : " + pizza.isEmpty());
