...
//메서드
	...
	public void practice1() {
		//배열을 사용해서 전체 합 구하기
		//배열을 사용할 때 제일 먼저
		//숫자인지 문자열인지 문자인지 실수인지 구분을 해준 후 [] 표 작성
		...
		// 				{1, 2, 3, 4, 5}
		for(int  숫자	:	num	) {
			// num 안에 있는 모듣ㄴ 숫자가 하나씩 숫자 안에 들어가고
			//숫자들의 합
	...
	public void practice2() {
		...
		//	new ArrayList<>() <>안에 String 을 넣어도 되고 안 넣어도 됨
	...
	public void practice4() {
		...
		String search = "바나나";
		boolean found = false;//아직은 찾았는지 안 찾았는지 모르기 떄문에 false
		...
		System.out.println(search + "찾음?" +(found? "찾았어" : "못찾았어"));
	...
	public void practice5() {
		...
		System.out.println(search + "찾았습니다?" + (found ? "찾았어요." : "못찾았어요."));
	}
}
