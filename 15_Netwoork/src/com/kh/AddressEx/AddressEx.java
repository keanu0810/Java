...
가장 기본 주소 
우리집주소 = 192.168.0.1 localhost 127.0.01

나중에 내 컴퓨터 실제 주소를 알고 싶다면 네이버 검색창에 ip주소 확인
 
port = 네트워크 에서 데이터를 주고 받을 수 있는 장소
타인의 컴퓨터나 도메인, 또는 특정위치에 들어갈수 있는 번호 2자리나 4자리


InetAddress : Java에서 IP 주소를 나타내는데 사용
	호스트명과 IP주소간으 ㅣ변환, 집주인에 대한 정보 검색 등을 가능하게 해줌
...
영어로 된 이름 주소와 숫자로 된 주소가 다른사람ㅇ ㅣ검색했을 경우와 내가 검색했을 때 숫자주소가
다르게 나오는 경우는 영어로 된 이름주소 주인이 진짜 본인의 실제 숫자 주소를 보호하기 위해
임시로 보여주는 숫자 주소이기 떄문에 개인이 다르게 보여지는 것임
 * */
public class AddressEx {
	...
	public static void main(String[] args) {
		...
		InetAddress 다음IP;
		try {
			다음IP = InetAddress.getByName("121.53.105.193");
